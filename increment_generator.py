...
def templates():
    ...
    return Environment(loader=PackageLoader('dcovr', 'templates'),
            autoescape=False,
            trim_blocks=True)
...
class UTCover(object) :
    ...
    def get_recoverage_info(self, changes):
        ...
        uncovers = {}
        lcov_changes = {}
        print "<<<< get_recoverage_info Begin."
    ...
    def create_coverage_trs(self, files_coverage_info):
        ...
        for f, v in files_coverage_info.items():
            ...
            if os.path.exists(gcovrfilepath):
                ...
                print "no such file %s" % gcovrfilepath
        return trs
    ...
    def create_report(self, changes, uncovers):
        ...
        increment_report_tpl = templates().get_template('delta_coverage_report.html')
...
def run_example():
    ...
    if DEBUG:
        print "input_test_1: ", input_test_1
